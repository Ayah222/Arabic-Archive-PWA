...
import {
  ...
  Mail, Inbox, Search, Wallet, HelpCircle, Users, LogOut, UserCog, MessageCircle, BadgeCheck,
} from "lucide-react";
...
const NAV_KEYS = [
  ...
  { to: "/agencies",      key: "agencies"      as const, Icon: BadgeCheck        },
                ...
                <div style={{
                  ...
                  <div style={{ maxHeight:380, overflowY:"auto" }}>
                    {notifications.length === 0 ? (
                      ...
                      const level = (n as { priority?: string; type?: string }).priority
                        ?? ((n as { type?: string }).type === "error" ? "high" : (n as { type?: string }).type === "warning" ? "medium" : "low");
