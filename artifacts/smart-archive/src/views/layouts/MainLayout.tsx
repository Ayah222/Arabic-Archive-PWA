      ...
      <aside
        ...
        <div className="p-4 flex items-center gap-3 min-h-[68px] relative overflow-hidden"
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[10px] mt-0.5 font-medium" style={{ color: isDark ? "rgba(0,240,255,0.55)" : "rgba(99,102,241,0.70)" }}>نظام إدارة الأرشيف</p>
          </div>
                ...
                <div style={{
                  ...
                  <div className="flex items-center justify-between px-4 py-3"
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-bold" style={{ color: isDark ? "#fff" : "#1e1b4b" }}>الإشعارات</span>
                      {unreadCount > 0 && (
                    ...
                    {unreadCount > 0 && (
                      <button onClick={markAllRead} className="flex items-center gap-1 text-xs font-bold transition-opacity hover:opacity-70" style={{ color: isDark ? "#00f0ff" : "#6366f1" }}>
                        <CheckCheck className="w-3.5 h-3.5" />تحديد الكل مقروء
                      </button>
                    )}
                  </div>
